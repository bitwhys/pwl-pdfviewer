...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-neutral-5 dark:bg-neutralDark-5">
      <SliderPrimitive.Range className="absolute h-full bg-primary-9  dark:bg-primaryDark-9" />
